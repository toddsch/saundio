...
public class TracksListPrefs extends PrefsHelper {
    ...
    public TracksListPrefs(Context context) {
        this(context, false);
    }

    public TracksListPrefs(Context context, boolean async) {
        super(context, TracksListPrefs.class.getName(), async);
    }
